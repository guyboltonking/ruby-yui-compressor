...
module YUI
  class CompressorTest < Test::Unit::TestCase
    ...
    FIXTURE_MULTIBYTE_JS = "var x = \"\xe2\x98\x96\";"
    ...
    def test_compress_should_handle_multibyte_charsets_in_input_when_default_internal_encoding_is_set
      old = [Encoding.default_internal, Encoding.default_external]
      Encoding.default_internal, Encoding.default_external = ['utf-8', 'utf-8']
      @compressor = YUI::JavaScriptCompressor.new
      assert_equal "var x=\"\xe2\x98\x96\";".
        force_encoding(Encoding.default_internal),
